/* -*- c++ -*-
 * $Id: qnap2_document.cpp 14590 2021-04-04 14:13:54Z greg $
 *
...
namespace BCMP {
	...
	const std::string integer_vars 	= std::accumulate( chains().begin(), chains().end(), std::string(""), getIntegerVariables( model(), symbol_table ) );
