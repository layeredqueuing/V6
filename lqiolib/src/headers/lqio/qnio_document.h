/* -*- c++ -*-
 * $HeadURL: http://rads-svn.sce.carleton.ca:8080/svn/lqn/trunk-V6/lqiolib/src/headers/lqio/qnio_document.h $
 *
 ...
 * November 2022
 *
 * $Id: qnio_document.h 17360 2024-10-12 10:59:43Z greg $
 *
 * ------------------------------------------------------------------------
 */
