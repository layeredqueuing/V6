/* -*- C++ -*-
 *  $Id: expat_document.h 15305 2021-12-31 16:01:37Z greg $
 *
...
namespace LQIO {
	...
	private:
	    ...
	    void startDecisionType( DocumentObject *, const XML_Char * element, const XML_Char ** attributes );
	    void startDecisionPathType( DocumentObject *, const XML_Char * element, const XML_Char ** attributes );
...
/*- SPEX */
	    ...
	    Decision * handleDecision( DocumentObject * object, const XML_Char ** attributes );
	...
	private:
	    ...
	    static const XML_Char *Xdecision;
	    static const XML_Char *Xresult_decision;
	    static const XML_Char *Xdecision_entry;
	    static const XML_Char *Xfrom_entry;
	    static const XML_Char *Xto_entry;
	    static const XML_Char *Xpath;	 
	    static const XML_Char *Xresult_decision_path; 
	    static const XML_Char *Xtimeout;
	    static const XML_Char *Xabort;
	    static const XML_Char *Xretry;
	    static const XML_Char *Xinf_retry;
	    static const XML_Char *Xsucc;
	    static const XML_Char *Xmax_retries;
	    static const XML_Char *Xsleep;
	    static const XML_Char *Xentry_name;
	    static const XML_Char *Xtimeout_prob;
	    static const XML_Char *Xtimeout_prob_variance;
	    static const XML_Char *Xsuccess_prob;
	    static const XML_Char *Xsuccess_prob_variance;
	    static const XML_Char *Xabort_prob;
	    static const XML_Char *Xabort_prob_variance;
	    static const XML_Char *Xnumber_of_retries;
	    static const XML_Char *Xnumber_of_retries_variance;
	};
    }
}
#endif /* */
