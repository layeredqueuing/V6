/* -*- C++ -*-
 *  $Id: qnap2_document.h 16004 2022-10-19 17:26:51Z greg $
 *
...
namespace QNIO {
	...
	bool defineVariable( Type type, const Variable& );
	bool defineStation();
	...
	std::vector<LQX::SyntaxTreeNode *>* appendProgram( std::vector<LQX::SyntaxTreeNode *>* );
