/* -*- c++ -*-
 *  $Id: dom_document.h 14106 2020-11-18 14:33:50Z greg $
 *
...
namespace LQIO {
	...
	public:
	    ...
	    Decision* getDecisionByName(const std::string& name) const;
	    DecisionPath* getDecisionPathByName(const std::string& name) const;
