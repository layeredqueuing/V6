/* -*- c++ -*-
 * $Id: glblerr.cpp 14872 2021-07-03 03:25:32Z greg $
 *
...
namespace LQIO {
	...
	{ RUNTIME_ERROR, "Precedence \"%s\" list previously defined." },							    /* ERR_DUPLICATE_X_LIST		    */
        { RUNTIME_ERROR, "Processor \"%s\" using fair share scheduling has invalid group share of %g." },                           /* ERR_INVALID_GROUP_SHARE              */
