# LQNS RPM file.
# ------------------------------------------------------------------------
# $Id: lqns.spec 16325 2023-01-12 17:47:10Z greg $
# ------------------------------------------------------------------------
...
rm -f lqn2out.%{product_man_section} 
rm -f lqn2png.%{product_man_section} 
rm -f lqn2svg.%{product_man_section} 
rm -f lqn2xml.%{product_man_section} 
rm -f rep2flat.%{product_man_section}  
rm -f lqn2lqx.%{product_man_section}  
