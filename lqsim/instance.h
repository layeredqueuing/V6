 ...
 *
 * $Id: instance.h 17458 2024-11-12 11:54:17Z greg $
 */
...
public:
    ...
    virtual const std::string& type_name() const { return Task::type_strings.at(Task::Type::TIMEOUT_QUEUE); }
    void run();
...
public:
    ...
    virtual const std::string& type_name() const { return Task::type_strings.at(Task::Type::RETRY_QUEUE); }
    void run();
