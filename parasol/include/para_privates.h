/* $Id: para_privates.h 12831 2016-09-19 17:07:18Z greg $ */
/************************************************************************/
...
#if HAVE_UCONTEXT_H && !defined(__OSX_AVAILABLE_BUT_DEPRECATED) && !defined(__POWERPC__)
#define ctxsw(old,new)	swapcontext(&(old)->u,&(new)->u)
