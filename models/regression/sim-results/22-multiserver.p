# lqsim 5.16
# lqsim --confidence=1.0,1000 --seed=1049217653 --parseable --output=22-multiserver.p 22-multiserver.in
# $Id: 22-multiserver.p 13830 2020-09-18 12:51:05Z greg $
V y
C 0.521757
I 3
PP 2
...
#!Comment: Equal clients and servers.  Wait = 0.
#!User:  0:38:47.000
#!Sys:   0:15:09.000
#!Real:  0:54:36.000
...
P server 1
server          1  0 3  server          1.49924     0           -1 
                                    %95 0.00486014  0           -1 
                                    %99 0.0112101   0           -1 
                        -1 
-1 
