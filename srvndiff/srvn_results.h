...
/*
 * $Id: srvn_results.h 13890 2020-09-29 02:12:10Z greg $
 */
...
void add_holding_time_confidence( const char * task, const char * acquire, const char * release, int conf_level, double time, double, double );
