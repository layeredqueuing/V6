/*  -*- c++ -*-
 * $Id: pragma.cc 15280 2021-12-28 13:11:27Z greg $ *
...
static const std::map<const std::string,const LQIO::DOM::Pragma::QuorumDelayedCalls> __quorum_delayed_calls_pragma =
{
