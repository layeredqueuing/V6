/* -*- c++ -*-
 * $HeadURL: http://rads-svn.sce.carleton.ca:8080/svn/lqn/trunk/lqns/dim.h $
 *
 ...
 * November, 1994
 *
 * $Id: dim.h 14639 2021-05-13 21:25:02Z greg $
 *
 * ------------------------------------------------------------------------
 */
...
#define PAN_REPLICATION	0			/* Use Amy Pan's replication	*/
#define BUG_299 1				/* Use new replication		*/
