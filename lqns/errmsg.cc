/* -*- c++ -*-
 * $HeadURL: http://rads-svn.sce.carleton.ca:8080/svn/lqn/trunk/lqns/errmsg.cc $
 *
 * Error messages.
 *
 ...
 *
 * ----------------------------------------------------------------------
 * $Id: errmsg.cc 14872 2021-07-03 03:25:32Z greg $
 * ----------------------------------------------------------------------
 */
...
struct LQIO::error_message_type local_error_messages[] =
{
    ...
    { LQIO::ADVISORY_ONLY, "The derived utilization of %g does not match the actual utilization of %g at processor \"%s\"." }, 		/* ADV_UTILIZATION_MISMATCH	*/
