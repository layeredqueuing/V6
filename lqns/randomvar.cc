/*  -*- c++ -*-
 * $HeadURL: http://rads-svn.sce.carleton.ca:8080/svn/lqn/branches/merge-V5-V6/lqns/randomvar.cc $
 *
 ...
 * January 2005.
 *
 * $Id: randomvar.cc 15332 2022-01-02 22:04:56Z greg $
 * ------------------------------------------------------------------------
 */
