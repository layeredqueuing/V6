 ...
 *
 * ------------------------------------------------------------------------
 * $Id: testmva.h 13398 2018-10-16 14:46:27Z greg $
 * ------------------------------------------------------------------------
 */
...
typedef enum {EXACT_SOLVER, LINEARIZER_SOLVER, LINEARIZER2_SOLVER, BARD_SCHWEITZER_SOLVER, EXPERIMENTAL_SOLVER } solverId;
