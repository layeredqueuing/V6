/*  -*- c++ -*-
 * $HeadURL: http://rads-svn.sce.carleton.ca:8080/svn/lqn/trunk/lqns/unit-test/testmva.cc $
 *
 * Example from:
 ...
 *
 * ------------------------------------------------------------------------
 * $Id: testmva.cc 13414 2018-10-23 16:16:04Z greg $
 * ------------------------------------------------------------------------
 */
...
#endif
const char opts[]	= "abdefhi:lnpst:vx";
const char * opthelp[]  = {
