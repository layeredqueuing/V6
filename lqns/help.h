...
private:
    ...
    ostream& flagJSON( ostream& output, bool verbose ) const;
...
public:
    ...
    ostream& traceCFS( ostream & output, bool verbose ) const;
    ostream& traceConvergence( ostream & output, bool verbose ) const;
    ostream& traceCustomers( ostream & output, bool verbose ) const;
    ...
    ostream& pragmaMVAFractional( ostream& output, bool verbose ) const;
