 ...
 * help.h	-- Greg Franks
 *
 * $Id: help.h 16756 2023-06-27 08:25:25Z greg $
 */
...
public:
    ...
    std::ostream& traceCFS( std::ostream & output, bool verbose ) const;
    std::ostream& traceConvergence( std::ostream & output, bool verbose ) const;
    std::ostream& traceCustomers( std::ostream & output, bool verbose ) const;
