/* -*- c++ -*-
 * $HeadURL: http://rads-svn.sce.carleton.ca:8080/svn/lqn/trunk-V6/lqns/flags.h $
 *
 ...
 * November, 1994
 *
 * $Id: flags.h 17200 2024-05-05 23:54:01Z greg $
 *
 * ------------------------------------------------------------------------
 */
...
extern struct FLAGS {
    ...
    unsigned json_output:1;			/* -j: Generate json output file	*/
