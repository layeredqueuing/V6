 ...
 *
 * $Id: help.cc 14957 2021-09-07 19:29:19Z greg $
 */
...
HelpTroff::preamble( std::ostream& output ) const
{
    ...
    output << __comment << " $Id: help.cc 14957 2021-09-07 19:29:19Z greg $" << std::endl
	   << __comment << std::endl
	   << __comment << " --------------------------------" << std::endl;
...
HelpLaTeX::preamble( std::ostream& output ) const
{
    ...
    output << __comment << "  -*- mode: latex; mode: outline-minor; fill-column: 108 -*- " << std::endl
	   ...
	   << __comment << "" << std::endl
	   << __comment << " ----------------------------------------------------------------------" << std::endl
	   << __comment << " $Id: help.cc 14957 2021-09-07 19:29:19Z greg $" << std::endl
