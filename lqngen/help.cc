...
man()
{
    ...
    cout << comm << " $Id: help.cc 17464 2024-11-13 12:55:06Z greg $" << endl
	 << comm << endl
	 << comm << " --------------------------------" << endl;
	...
	case 0x100+'j':
	    cout << "Output the input model in Java Script Object Notation (JSON)." << endl;
	    break;
	...
	case 'O':
	    cout << "Set the output file format, " << emph( "ARG" ) << ", to: " << emph( "xml" ) << ", " << emph( "lqn" ) << ", or " << emph( "json" ) << "." << endl
		 << "Note that JSON output cannot be used to run experiments at this time." << endl;
	    break;
