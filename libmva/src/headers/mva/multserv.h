/* -*- c++ -*-
 * $HeadURL: http://rads-svn.sce.carleton.ca:8080/svn/lqn/branches/merge-V5-V6/libmva/src/headers/mva/multserv.h $
 *
 ...
 * November, 2021
 *
 * $Id: multserv.h 15987 2022-10-17 10:37:37Z greg $
 *
 * ------------------------------------------------------------------------
 */
...
protected:
    ...
    virtual Positive sumOf_SQL( const MVA& solver, const Population& N, const unsigned k ) const;
private:
    void initialize();
    double A() const;
...
protected:
    ...
    virtual Positive sumOf_QL( const MVA& solver, const Population& N, const unsigned k ) const;
};

/*----------------------------------------------------------------------*/
/*                         Conway Multi-Server				*/
...
protected:
    ...
    double effectiveBacklog_adjusted( const MVA& solver, const Population& N, const unsigned k ) const;
