/* -*- c++ -*-
 * $HeadURL: http://rads-svn.sce.carleton.ca:8080/svn/lqn/branches/merge-V5-V6/libmva/src/headers/mva/pop.h $
 *
 * Exported goodies.
 *
 ...
 * November, 1994
 *
 * $Id: pop.h 15492 2022-04-01 16:04:00Z greg $
 *
 * ------------------------------------------------------------------------
 */
...
public:
    ...
    **/
    ...
    virtual unsigned offset_e_j_mc( const Population & N, const unsigned j, const unsigned mc ) const = 0;
