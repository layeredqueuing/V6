 ...
 * August, 2005
 *
 * $Id: mva.h 14872 2021-07-03 03:25:32Z greg $
 *
 * ------------------------------------------------------------------------
 */
...
public:
    ...
    double sumOf_LL_m( const Server& station, const Population &N, const unsigned j ) const;
    double sumOf_QL_m( const Server& station, const Population &N, const unsigned j ) const;
    double avg_S_m(const Server& station, const Population &N, const unsigned k, const unsigned je ) const;
    virtual double sumOf_SL_m( const Server& station, const Population &N, const unsigned j ) const;
    virtual double sumOf_SL_m( const Server& station, const Population &N, const unsigned je, const unsigned j ) const;
...
public:
    ...
    static bool __enable_interlock;
